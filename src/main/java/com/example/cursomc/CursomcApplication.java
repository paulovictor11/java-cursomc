...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Paulo Victor", "paulo@email.com", "1112223344", TipoCliente.PESSOAFISICA);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("05/06/2021 11:43"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("05/06/2021 11:43"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("06/05/2021 00:00"), null);
